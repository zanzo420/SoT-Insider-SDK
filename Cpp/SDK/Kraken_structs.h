...
struct FCoordinatedKrakenSpecialEvent
{
	...
	unsigned char                                      UnknownData_NHUL[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              TimeOffset;                                                // 0x0004(0x0004) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_MPT9[0x4];                                     // 0x0008(0x0004) MISSED OFFSET (PADDING)
...
struct FCoordinatedKrakenTentacleAction
{
	...
	unsigned char                                      UnknownData_4M42[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (PADDING)
...
struct FCoordinatedKrakenHeadAction
{
	...
	unsigned char                                      UnknownData_AB2P[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FCoordinatedKrakenExplosionEvent
{
	...
	float                                              TimeOffset;                                                // 0x0004(0x0004) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_SVCZ[0x4];                                     // 0x0008(0x0004) MISSED OFFSET (PADDING)
...
struct FCoordinatedKrakenAction
{
	...
	unsigned char                                      UnknownData_4Z79[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenShipWrappingTentacleAnimationStateParams
{
	...
	unsigned char                                      UnknownData_6RDN[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenShipWrappingTentacleAnimationState
{
	...
	unsigned char                                      UnknownData_N6Q4[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenShipWrappingTentacleVFXParams
{
	...
	unsigned char                                      UnknownData_PNMY[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FKrakenShipWrappingTentacleParams
{
	...
	unsigned char                                      UnknownData_4KZ4[0x4];                                     // 0x009C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenWeightedBehaviour
{
	...
	unsigned char                                      UnknownData_K7QW[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FKrakenBehaviourParams
{
	...
	unsigned char                                      UnknownData_E54B[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenTentaclesChanceParams
{
	...
	unsigned char                                      UnknownData_6QH2[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenTentacleParams
{
	...
	unsigned char                                      UnknownData_XRDM[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
...
struct FKrakenParams
{
	...
	unsigned char                                      UnknownData_MO8D[0x4];                                     // 0x0084(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GXI3[0x4];                                     // 0x015C(0x0004) MISSED OFFSET (PADDING)
...
struct FKrakenAnimatedTentacleTransitionAnimation
{
	...
	unsigned char                                      UnknownData_183Z[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenAnimatedTentacleStateAnimationMapping
{
	...
	unsigned char                                      UnknownData_EFEX[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenHeadStateAnimationMapping
{
	...
	class UAnimSequence*                               Animation;                                                 // 0x0008(0x0008) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                               Loop;                                                      // 0x0010(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor)
	unsigned char                                      UnknownData_OMEW[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenHeadHitReactAnimations
{
	...
	unsigned char                                      UnknownData_2HL1[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenTentacleBehaviourActionChances
{
	...
	unsigned char                                      UnknownData_Q2DX[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenTentacleBehaviourParams
{
	...
	unsigned char                                      UnknownData_X9C6[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VLV0[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenPlayerGrabbingHoldingStateTransitionChance
{
	...
	unsigned char                                      UnknownData_SJ21[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenPlayerGrabbingBehaviourParams : public FKrakenTentacleBehaviourParams
{
	...
	unsigned char                                      UnknownData_VPLX[0x4];                                     // 0x00E4(0x0004) MISSED OFFSET (PADDING)
...
struct FKrakenServiceSpawnParams
{
	...
	unsigned char                                      UnknownData_LIIW[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	int                                                Weight;                                                    // 0x0000(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_OKAJ[0xC];                                     // 0x0004(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8AQP[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FWeightedProbabilityRangeOfRanges           NumZonesToDamage;                                          // 0x0068(0x0030) (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData_ARB7[0x8];                                     // 0x0098(0x0008) MISSED OFFSET (PADDING)
...
struct FKrakenShipHittingBehaviourParams
{
	...
	unsigned char                                      UnknownData_W7EH[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenDynamicsStateEvent
{
	...
	unsigned char                                      UnknownData_8UB2[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenShipWrappingBehaviourHealthParams
{
	...
	unsigned char                                      UnknownData_FHBQ[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (PADDING)
...
struct FKrakenShipWrappingBehaviourNamedTransform
{
	...
	unsigned char                                      UnknownData_MWUU[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenShipWrappingBehaviourWarningParams
{
	...
	unsigned char                                      UnknownData_IL64[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_X7EV[0x8];                                     // 0x0068(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenDynamicsStateFragmentParams
{
	...
	unsigned char                                      UnknownData_PGFI[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenShipWrappingBehaviourWrapLocationParams
{
	...
	unsigned char                                      UnknownData_AZAR[0xC];                                     // 0x0014(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	float                                              Weight;                                                    // 0x0000(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_7Y6Z[0xC];                                     // 0x0004(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenShipWrappingBehaviourWrapParams
{
	...
	unsigned char                                      UnknownData_MENK[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_U1PW[0xC];                                     // 0x0054(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenShipWrappingBehaviourHeavyAttackParams
{
	...
	unsigned char                                      UnknownData_6L8Q[0x4];                                     // 0x00D4(0x0004) MISSED OFFSET (PADDING)
...
struct FKrakenShipWrappingBehaviourDamageParams
{
	...
	unsigned char                                      UnknownData_N4GB[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	class UClass*                                      ShipSize;                                                  // 0x0000(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
	unsigned char                                      UnknownData_W3DC[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCoordinatedKrakenPhaseAssetEntry
{
	...
	unsigned char                                      UnknownData_HYG2[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_QH10[0x4];                                     // 0x0000(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_MU7Y[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_31PR[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_TDIL[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_ZPXY[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_6ZRN[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_S6MJ[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_KAQX[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_7Y48[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_FYJL[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_7039[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_2O13[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_INAU[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_VW60[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FEventKrakenAnimatedTentacleAnimationStarted
{
	...
	unsigned char                                      UnknownData_WVXZ[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_B6E6[0x4];                                     // 0x0000(0x0004) MISSED OFFSET (PADDING)
...
struct FEventKrakenAnimatedTentacleStateEntered
{
	...
	unsigned char                                      UnknownData_D4CW[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_L8V1[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_4HXO[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FKrakenDespawnTelemetryEvent
{
	...
	unsigned char                                      UnknownData_NJRA[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
