...
public:
	...
	unsigned char                                      UnknownData_GE64[0xF];                                     // 0x0029(0x000F) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_NCY8[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_UBIQ[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_EWKD[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_EDJG[0x18];                                    // 0x0028(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_ORZ6[0x50];                                    // 0x0040(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_NXQI[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BMNN[0x7];                                     // 0x00D9(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_PP42[0x8];                                     // 0x0190(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_U420[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_QFTW[0x18];                                    // 0x0068(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FFF5[0x48];                                    // 0x0088(0x0048) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_F7LA[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_EOM1[0x40];                                    // 0x0068(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_SVIO[0x20];                                    // 0x0068(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_HFC9[0x20];                                    // 0x0068(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class UClueFactoryConfig*                          ClueConfig;                                                // 0x0088(0x0008) (ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	unsigned char                                      UnknownData_50P9[0x20];                                    // 0x0070(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_4O54[0x20];                                    // 0x0070(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_130Y[0x20];                                    // 0x0068(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_BFMJ[0x27];                                    // 0x0079(0x0027) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_LT9F[0x7];                                     // 0x0041(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_8PJU[0x48];                                    // 0x0068(0x0048) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_S387[0x7];                                     // 0x0061(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_EPPR[0x18];                                    // 0x0068(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_MK6B[0x7];                                     // 0x0041(0x0007) MISSED OFFSET (PADDING)
