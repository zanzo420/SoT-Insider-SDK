...
{
public:
	unsigned char                                      UnknownData_NAQ2[0x10];                                    // 0x0068(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_2M16[0x20];                                    // 0x0100(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_VPE3[0x28];                                    // 0x0068(0x0028) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_V0LS[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
