...
{
public:
	unsigned char                                      UnknownData_N8HR[0x28];                                    // 0x00C8(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class ADebugMenu*                                  DebugMenuInstance;                                         // 0x00F0(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_7AM4[0x20];                                    // 0x00F8(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_R80Q[0x60];                                    // 0x03D0(0x0060) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_Z5TO[0x8];                                     // 0x0118(0x0008) MISSED OFFSET (PADDING)
