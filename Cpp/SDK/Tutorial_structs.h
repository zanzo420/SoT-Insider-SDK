...
struct FContextualTutorialPromptDesc
{
	...
	unsigned char                                      UnknownData_E2SN[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FBeachNPCSpawnFlowNetworkEvent : public FNetworkEventStruct
{
	...
	unsigned char                                      UnknownData_1QRB[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FTutorialStepEndedTelemetryEvent
{
	...
	unsigned char                                      UnknownData_S8AZ[0x6];                                     // 0x0022(0x0006) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_XPFG[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
