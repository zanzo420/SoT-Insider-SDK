...
// BlueprintGeneratedClass BP_SkeletonFortStorageBarrel.BP_SkeletonFortStorageBarrel_C
// 0x0018 (FullSize[0x04D8] - InheritedSize[0x04C0])
class ABP_SkeletonFortStorageBarrel_C : public AStorageContainer
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_SkeletonFortStorageBarrel.BP_SkeletonFortStorageBarrel_C");
		return ptr;
	}
