...
public:
	...
	unsigned char                                      UnknownData_WFMT[0x1C];                                    // 0x00CC(0x001C) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class AthenaServerMigration.RegisterServerMigrationPointOfInterestComponent");
		return ptr;
	}
