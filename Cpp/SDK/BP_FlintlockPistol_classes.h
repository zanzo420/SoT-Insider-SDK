...
{
public:
	unsigned char                                      UnknownData_WJJH[0x4];                                     // 0x0A1C(0x0004) Fix Super Size
	...
	unsigned char                                      UnknownData_8K84[0x7];                                     // 0x0A31(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
