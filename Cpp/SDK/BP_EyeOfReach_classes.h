...
{
public:
	unsigned char                                      UnknownData_CDN6[0x4];                                     // 0x0A1C(0x0004) Fix Super Size
	...
	unsigned char                                      UnknownData_DLVA[0x7];                                     // 0x0A39(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_37H4[0x3];                                     // 0x0A49(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
