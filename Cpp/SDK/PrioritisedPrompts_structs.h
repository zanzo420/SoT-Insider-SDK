...
struct FPrioritisedPrompt
{
	...
	unsigned char                                      UnknownData_4NK4[0x20];                                    // 0x0000(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_LD89[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (PADDING)
...
struct FPromptEvaluation
{
	...
	unsigned char                                      UnknownData_1M7S[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPermanentPromptNetworkEvent : public FNetworkEventStruct
{
	...
	unsigned char                                      UnknownData_C8WV[0x7];                                     // 0x0079(0x0007) MISSED OFFSET (PADDING)
