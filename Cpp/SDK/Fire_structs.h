...
struct FFireGridCellSelection
{
	...
	unsigned char                                      UnknownData_W8WC[0x2];                                     // 0x0012(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFireCellStateParticleTemplate
{
	...
	unsigned char                                      UnknownData_H50V[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RSDV[0x2];                                     // 0x002E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CY1T[0x2];                                     // 0x0036(0x0002) MISSED OFFSET (PADDING)
...
struct FFireMesh
{
	...
	unsigned char                                      UnknownData_HW1C[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
struct FFireParticleSpawnData
{
	...
	unsigned char                                      UnknownData_GWEJ[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
struct FFireParticleSpawnList
{
	...
	unsigned char                                      UnknownData_TFG5[0x10];                                    // 0x0010(0x0010) MISSED OFFSET (PADDING)
...
struct FFireCellDesc
{
	...
	unsigned char                                      UnknownData_SJ4K[0x1];                                     // 0x0037(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2QVN[0xF];                                     // 0x0041(0x000F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFireDefaultVFXSpawnData
{
	...
	unsigned char                                      UnknownData_NB97[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFireParticleSystem
{
	...
	unsigned char                                      UnknownData_NHIK[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FActorFireDamageParams
{
	...
	unsigned char                                      UnknownData_119C[0x4];                                     // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_ZGXY[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
struct FShipFireLightRelativeSpawnDesc : public FFireGridRelativeSpawnDesc
{
	...
	unsigned char                                      UnknownData_Z9GK[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FReplicatedFireCellCharringData
{
	...
	unsigned char                                      UnknownData_UENC[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFireGridCharringManager
{
	...
	unsigned char                                      UnknownData_PJTW[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MUC6[0xA0];                                    // 0x0028(0x00A0) MISSED OFFSET (PADDING)
...
struct FShipFireLight
{
	...
	unsigned char                                      UnknownData_L5PM[0x20];                                    // 0x0070(0x0020) MISSED OFFSET (PADDING)
...
struct FShipFireLightManager
{
	...
	unsigned char                                      UnknownData_NJSF[0x4];                                     // 0x0114(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HTY2[0x28];                                    // 0x0128(0x0028) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_PB78[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_IP80[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_2OBY[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_YHRG[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_W0B7[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AMY9[0x10];                                    // 0x0038(0x0010) MISSED OFFSET (PADDING)
