...
{
public:
	unsigned char                                      UnknownData_UG46[0x8];                                     // 0x03D0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JRZK[0x7F];                                    // 0x0449(0x007F) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_DW8I[0xC];                                     // 0x03EC(0x000C) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_Q427[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
