...
{
public:
	unsigned char                                      UnknownData_4PMX[0x38];                                    // 0x0028(0x0038) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_K7M9[0x28];                                    // 0x0028(0x0028) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      pad_305SAYMVTP[0x40];                                      // 0x0048(0x0040) NOT AUTO-GENERATED PROPERTY
...
{
public:
	unsigned char                                      UnknownData_485T[0x10];                                    // 0x0088(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_JNJ8[0x58];                                    // 0x0028(0x0058) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_ZMGI[0x138];                                   // 0x0088(0x0138) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      pad_53AE24NOV3[0x04];                                      // 0x00AC(0x0004) NOT AUTO-GENERATED PROPERTY
	void*                                              Func;                                                      // 0x00B0(0x0008) NOT AUTO-GENERATED PROPERTY
	unsigned char                                      pad_8F8DX2ZBY8[0x8];                                       // 0x00B8(0x0008) NOT AUTO-GENERATED PROPERTY
...
{
public:
	unsigned char                                      UnknownData_NGBI[0x10];                                    // 0x00B8(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_9VNL[0x28];                                    // 0x0028(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_5KBZ[0x28];                                    // 0x0030(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_UQSB[0x150];                                   // 0x01C0(0x0150) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_JJXE[0x60];                                    // 0x0028(0x0060) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_Y1QC[0x150];                                   // 0x00B8(0x0150) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_3TZA[0x50];                                    // 0x0028(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_9D29[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_RPK4[0x40];                                    // 0x0030(0x0040) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_ZR4Q[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_FDKX[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_CF1O[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_JW5K[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_R6GV[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_Z9OP[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_6NM2[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_SCHE[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_GYL1[0x38];                                    // 0x0070(0x0038) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_OG8V[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_R39X[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
