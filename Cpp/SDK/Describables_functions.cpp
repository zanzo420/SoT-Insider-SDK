...
{
	static auto fn = UObject::FindObject<UFunction>("Function Describables.DescribableComponent.SetTooltipActive");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Describables.DescribableComponent.OnRep_TooltipActive");
