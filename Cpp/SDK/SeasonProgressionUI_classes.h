...
{
public:
	unsigned char                                      UnknownData_X9PF[0x10];                                    // 0x00C8(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_C4AP[0xB8];                                    // 0x0110(0x00B8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_RM7N[0x20];                                    // 0x00D8(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_OTM6[0x30];                                    // 0x03D0(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_R1UF[0x118];                                   // 0x0408(0x0118) MISSED OFFSET (PADDING)
