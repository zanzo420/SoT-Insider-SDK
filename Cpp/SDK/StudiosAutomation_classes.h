...
{
public:
	unsigned char                                      UnknownData_EXVB[0x8];                                     // 0x03D8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZS89[0x2];                                     // 0x03E6(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_A431[0x2];                                     // 0x03FA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_I2AL[0x4];                                     // 0x0404(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_13B9[0x3C];                                    // 0x045C(0x003C) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_SV1X[0x38];                                    // 0x0028(0x0038) MISSED OFFSET (PADDING)
