...
public:
	...
	unsigned char                                      UnknownData_FHJT[0xA8];                                    // 0x0038(0x00A8) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_I7BZ[0x38];                                    // 0x00E8(0x0038) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_XY56[0x6];                                     // 0x00CA(0x0006) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_57O1[0x1C];                                    // 0x00F4(0x001C) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_U2PD[0x2];                                     // 0x0032(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
