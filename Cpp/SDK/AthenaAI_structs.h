...
struct FAthenaAIFormComponentVfxCustomisation
{
	...
	unsigned char                                      UnknownData_5PJG[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAIEncounterAndWaveSettingsOverride
{
	...
	unsigned char                                      UnknownData_HFSS[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FAdditionalSpawnerBehaviour
{
	...
	unsigned char                                      UnknownData_ZN2Q[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
struct FAIFormDamageResponse
{
	...
	unsigned char                                      UnknownData_0HCI[0x1];                                     // 0x000F(0x0001) MISSED OFFSET (PADDING)
...
struct FAIAbilityFollowUp
{
	...
	unsigned char                                      UnknownData_PH0K[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FAthenaAIAbilityPlayerBasedRange
{
	...
	unsigned char                                      UnknownData_804Q[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAttackableTypeToAnimMapping
{
	...
	unsigned char                                      UnknownData_7XW4[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_29YN[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAISpawnContextIdEncounterSettingsPair
{
	...
	unsigned char                                      UnknownData_LUD9[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAIEncounterSpecification
{
	...
	unsigned char                                      UnknownData_NGN2[0x4];                                     // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_YK45[0x4];                                     // 0x0050(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_VWKC[0x4];                                     // 0x007C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FText                                       LocalisableName;                                           // 0x0080(0x0018) ELEMENT_SIZE_MISMATCH
	unsigned char                                      UnknownData_TE4Y[0x20];                                    // 0x007C(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_5SOO[0x2];                                     // 0x00C6(0x0002) MISSED OFFSET (PADDING)
...
struct FAISpawnTypeParams
{
	...
	unsigned char                                      UnknownData_5N29[0x4];                                     // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_GXF2[0x4];                                     // 0x0060(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_6X2T[0x4];                                     // 0x00AC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FText                                       LocalisableName;                                           // 0x00B0(0x0018) ELEMENT_SIZE_MISMATCH (Edit)
	unsigned char                                      UnknownData_O9M3[0x20];                                    // 0x00AC(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	unsigned char                                      UnknownData_NNXQ[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FWeightedAISpawnTypeParams>          SpawnParams;                                               // 0x0008(0x0010) (Edit, ZeroConstructor)
	unsigned char                                      UnknownData_JW1H[0x30];                                    // 0x0018(0x0030) MISSED OFFSET (PADDING)
...
struct FAthenaAIControllerSenseSettings
{
	...
	unsigned char                                      UnknownData_8BXF[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAthenaAIControllerHealthCustomisation
{
	...
	unsigned char                                      UnknownData_T8TA[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAthenaAIControllerSenseSettingOverride
{
	...
	unsigned char                                      UnknownData_9MPF[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FAthenaAIItemParamValue
{
	...
	unsigned char                                      UnknownData_XI8N[0x4];                                     // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_7T85[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FAthenaAICharacterControllerWeightedAmmoType
{
	...
	unsigned char                                      UnknownData_YQ1V[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FAIDebugVisualisationLine
{
	...
	unsigned char                                      UnknownData_AZGF[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FAIDebugVisualisationCone
{
	...
	unsigned char                                      UnknownData_60IV[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (PADDING)
...
struct FAIDebugVisualisationSphere
{
	...
	unsigned char                                      UnknownData_S7QK[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
struct FAIDropSpawnerRankMapping
{
	...
	unsigned char                                      UnknownData_0DD3[0x4];                                     // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FAITypeData
{
	...
	unsigned char                                      UnknownData_0MDS[0x3];                                     // 0x0041(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Z24H[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (PADDING)
...
struct FAISpawnerWave
{
	...
	unsigned char                                      UnknownData_WY0P[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCustomPlayersAITrackerData
{
	...
	unsigned char                                      UnknownData_FL3N[0x18];                                    // 0x0008(0x0018) MISSED OFFSET (PADDING)
...
struct FTinySharkParams
{
	...
	unsigned char                                      UnknownData_VAJD[0x4];                                     // 0x0018(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_EXT1[0x4];                                     // 0x0038(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_49Q7[0x4];                                     // 0x0058(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FAIDebugVisualisationCylinder
{
	...
	unsigned char                                      UnknownData_1YGW[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (PADDING)
...
struct FAIDebugVisualisationBox
{
	...
	unsigned char                                      UnknownData_HTW7[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5LIH[0xB];                                     // 0x0035(0x000B) MISSED OFFSET (PADDING)
...
struct FAIIndividualVarietyEntry
{
	...
	unsigned char                                      UnknownData_WGS2[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FAIPersistentSpawnerWave : public FAISpawnerWave
{
	...
	unsigned char                                      UnknownData_JWRJ[0x17];                                    // 0x0101(0x0017) MISSED OFFSET (PADDING)
...
struct FWeightedAmmoType
{
	...
	unsigned char                                      UnknownData_HVKI[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FWeightedAmmoTypeRange
{
	...
	unsigned char                                      UnknownData_X0EL[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCarriedItemThreatOverride
{
	...
	unsigned char                                      UnknownData_OWSW[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FBlackboardValueCondition
{
	...
	unsigned char                                      UnknownData_CDL1[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AMK0[0x6];                                     // 0x0032(0x0006) MISSED OFFSET (PADDING)
...
struct FConditionalBasedOnBlackboardKey
{
	...
	unsigned char                                      UnknownData_PVC4[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IMLA[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_OPQ3[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_6DOF[0x38];                                    // 0x0000(0x0038) MISSED OFFSET (PADDING)
...
struct FAICustomNameTitleMapping
{
	...
	unsigned char                                      UnknownData_OC7P[0x20];                                    // 0x0008(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	unsigned char                                      UnknownData_C8LC[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
struct FSirenEncounterData
{
	...
	unsigned char                                      UnknownData_WOYZ[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (PADDING)
...
struct FAIBountySpawnerWave : public FAIPersistentSpawnerWave
{
	...
	bool                                               IsUsingDialogue;                                           // 0x011A(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor)
	TEnumAsByte<AthenaAI_EBountyTargetGender>          Gender;                                                    // 0x011B(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TEnumAsByte<AthenaAI_EBountyTargetRank>            Rank;                                                      // 0x011C(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_QQYJ[0x3];                                     // 0x011D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZYFU[0x38];                                    // 0x0128(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAIBountySpawnerWaveGroup
{
	...
	unsigned char                                      UnknownData_ADNU[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NVGN[0x10];                                    // 0x0020(0x0010) MISSED OFFSET (PADDING)
...
struct FAIDioramaPawn
{
	...
	unsigned char                                      UnknownData_ZWNQ[0x40];                                    // 0x0008(0x0040) MISSED OFFSET (PADDING)
...
struct FAIDioramaLocationSourceComponentData
{
	...
	unsigned char                                      UnknownData_IODD[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (PADDING)
...
struct FDioramaCategoryEntries
{
	...
	unsigned char                                      UnknownData_ZKWL[0x50];                                    // 0x0050(0x0050) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_HCYC[0x10];                                    // 0x0100(0x0010) MISSED OFFSET (PADDING)
...
struct FAIStategyControllerMovementMod
{
	...
	unsigned char                                      UnknownData_DKY7[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FTinySharkServiceParams
{
	...
	unsigned char                                      UnknownData_V30B[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FPetFlyingStrategyProperties
{
	...
	unsigned char                                      UnknownData_AU8J[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FPetMovementRequest
{
	...
	unsigned char                                      UnknownData_ZK1K[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WDMY[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FPetTurnRateModifier
{
	...
	unsigned char                                      UnknownData_TRNP[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FPetLoadedMaterial
{
	...
	unsigned char                                      UnknownData_GH9M[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (PADDING)
...
struct FPetPartSizeMapping
{
	...
	unsigned char                                      UnknownData_71GO[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPetMaterialEntry
{
	...
	unsigned char                                      UnknownData_2K6B[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FAIBountySpawnerParams
{
	...
	TArray<class UClass*>                              AICombatDialogue;                                          // 0x00A8(0x0010) (ZeroConstructor, UObjectWrapper)
...
struct FEventAIStartedDeadActionState
{
	...
	unsigned char                                      UnknownData_T3T1[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEventPawnFinishedDying
{
	...
	unsigned char                                      UnknownData_O759[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (PADDING)
...
struct FEventPawnStartedDying
{
	class APawn*                                       AIPawn;                                                    // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TEnumAsByte<Athena_ECharacterDeathType>            DeathType;                                                 // 0x0008(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_IM41[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	TEnumAsByte<Athena_ECharacterDeathType>            DeathType;                                                 // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_YC6U[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_OCNK[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_CIL8[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FAIFixedWavesSpawnerArchive : public FAISpawnerArchive
{
	...
	unsigned char                                      UnknownData_2U1H[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_3OZG[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_LPBK[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
struct FAIProgressiveWavesSpawnerArchive : public FAISpawnerArchive
{
	...
	unsigned char                                      UnknownData_WWP1[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FAthenaAIControllerTargetPickingData
{
	...
	unsigned char                                      UnknownData_53Z8[0x2];                                     // 0x0012(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_MT8E[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_SVHE[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_YXXX[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_5YA1[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_56PT[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_X7HB[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_61LP[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_YWAL[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_YU4A[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_Y4WU[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_N1CQ[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FEventAILoadoutSelected
{
	...
	unsigned char                                      UnknownData_E4ST[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_44MR[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FEventOwnedPawnFinishedSpawning
{
	...
	unsigned char                                      UnknownData_KAVF[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FKIC[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	class AActor*                                      Player;                                                    // 0x0000(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_D5Q6[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
{
	class AActor*                                      Player;                                                    // 0x0000(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_MCSZ[0x18];                                    // 0x0008(0x0018) MISSED OFFSET (PADDING)
...
{
	class AActor*                                      Player;                                                    // 0x0000(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_R5P0[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
{
	class AActor*                                      Player;                                                    // 0x0000(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_MBWC[0x18];                                    // 0x0008(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_4PWU[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FEventAIPawnRemovedFromAIRegion
{
	...
	unsigned char                                      UnknownData_4KYL[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
{
	class APawn*                                       AIPawn;                                                    // 0x0000(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_JIW1[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
struct FEventOceanCrawlerAIAbilityAudioRequest
{
	...
	unsigned char                                      UnknownData_T0J6[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAIActorTimeout
{
	...
	unsigned char                                      UnknownData_OF5T[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FBountySpawnerTargetDesc
{
	...
	unsigned char                                      UnknownData_6X0W[0x16];                                    // 0x0002(0x0016) MISSED OFFSET (PADDING)
...
struct FAIBountySpawnerWaveLocation
{
	...
	unsigned char                                      UnknownData_MSMZ[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
{
	int                                                CurrentWaveIndex;                                          // 0x0008(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_5HEY[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VTL2[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FBountySpawnerAudioChangedNetworkEvent : public FNetworkEventStruct
{
	...
	unsigned char                                      UnknownData_D2KP[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_F9UU[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEventAIBountySpawnerTargetKilled
{
	...
	unsigned char                                      UnknownData_QEAL[0x20];                                    // 0x0000(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_43V6[0x3];                                     // 0x0049(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_6IGK[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FEventSwimRotationModeChanged
{
	...
	unsigned char                                      UnknownData_AGCP[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_DUXS[0x48];                                    // 0x0000(0x0048) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_UFTP[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FTinySharkDespawnTelemetryEvent
{
	...
	unsigned char                                      UnknownData_Y0I0[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
