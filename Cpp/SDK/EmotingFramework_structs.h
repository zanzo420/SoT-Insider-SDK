...
struct FEmoteData
{
	...
	unsigned char                                      UnknownData_IH56[0x20];                                    // 0x0008(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FText                                       AudioDescription;                                          // 0x0040(0x0018) ELEMENT_SIZE_MISMATCH (Edit)
	unsigned char                                      UnknownData_Y1O4[0x20];                                    // 0x0040(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_6AQ5[0x7];                                     // 0x0081(0x0007) MISSED OFFSET (PADDING)
...
struct FEventEmoteEndRequested
{
	...
	unsigned char                                      UnknownData_2Q5Q[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_TVDE[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FEventEmoteRequested
{
	...
	unsigned char                                      UnknownData_8REI[0x7];                                     // 0x0091(0x0007) MISSED OFFSET (PADDING)
