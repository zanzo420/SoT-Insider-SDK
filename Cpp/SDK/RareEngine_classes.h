...
{
public:
	unsigned char                                      UnknownData_5TPM[0x58];                                    // 0x09E8(0x0058) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_D7LL[0x18];                                    // 0x0028(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_XWVH[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FScriptMulticastDelegate                    Callback;                                                  // 0x0030(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData_PX71[0x10];                                    // 0x0040(0x0010) MISSED OFFSET (PADDING)
