...
{
public:
	unsigned char                                      UnknownData_6EUH[0x8];                                     // 0x0578(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_LLBU[0x4];                                     // 0x0594(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3G36[0x10];                                    // 0x06B8(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FJB5[0x10];                                    // 0x06E8(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_P17N[0x7];                                     // 0x0729(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class AActor*                                      TargetActor;                                               // 0x0730(0x0008) (Net, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_T1Y9[0x70];                                    // 0x0738(0x0070) Fix Super Size
...
public:
	...
	unsigned char                                      UnknownData_E2RW[0xD0];                                    // 0x03F0(0x00D0) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_FGBM[0x3];                                     // 0x007D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_S8O3[0x1E];                                    // 0x008A(0x001E) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_44WD[0x28];                                    // 0x00E8(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_AW8J[0x30];                                    // 0x04C8(0x0030) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_JVVC[0x4];                                     // 0x0404(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_M5GU[0x1];                                     // 0x0427(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6L9K[0x4E];                                    // 0x0432(0x004E) MISSED OFFSET (PADDING)
