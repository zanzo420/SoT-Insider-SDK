...
public:
	...
	unsigned char                                      UnknownData_F7C5[0x3];                                     // 0x00ED(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9OXZ[0x4];                                     // 0x00F4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_37LG[0x50];                                    // 0x0108(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_QZ3I[0x8];                                     // 0x03D0(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_B93J[0x8];                                     // 0x03D0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0ZO3[0x50];                                    // 0x03F8(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_MM6L[0x38];                                    // 0x0040(0x0038) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_IN12[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_RM6G[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_0RMB[0x50];                                    // 0x0068(0x0050) MISSED OFFSET (PADDING)
