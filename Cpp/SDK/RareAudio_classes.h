...
{
public:
	unsigned char                                      UnknownData_F9A2[0x8];                                     // 0x02B0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_8JCN[0x7];                                     // 0x0041(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0O5Z[0x20];                                    // 0x0050(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_HNQD[0x50];                                    // 0x0038(0x0050) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_AZZG[0x6];                                     // 0x003A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FWwiseNativeEmitterPoolDensityParams        PoolDensityParams;                                         // 0x0040(0x0028) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      UnknownData_1GM0[0x18];                                    // 0x0068(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_0JNI[0x13];                                    // 0x02CD(0x0013) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_YUS5[0xB0];                                    // 0x0028(0x00B0) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_KXKX[0x8];                                     // 0x05E8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_JVT2[0x10];                                    // 0x0040(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_D7G8[0x28];                                    // 0x0038(0x0028) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_7NO9[0x4];                                     // 0x02BC(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_2GE8[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Q2XF[0xA8];                                    // 0x0048(0x00A8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4IMF[0x38];                                    // 0x00F8(0x0038) MISSED OFFSET (PADDING)
