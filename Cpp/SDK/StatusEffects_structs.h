...
struct FStatus
{
	...
	unsigned char                                      UnknownData_0Z2X[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FDelayedStatusEffect
{
	...
	unsigned char                                      UnknownData_A2OP[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FActiveStatusEffect
{
	...
	unsigned char                                      UnknownData_7DIV[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IJV9[0x17];                                    // 0x0039(0x0017) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_G7N0[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
