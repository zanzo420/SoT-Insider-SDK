...
public:
	...
	unsigned char                                      UnknownData_8G6F[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_NRY2[0x18];                                    // 0x0080(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_RBMV[0x20];                                    // 0x0080(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FText                                       CachedWidgetVisibilityText;                                // 0x00B8(0x0018) ELEMENT_SIZE_MISMATCH
	unsigned char                                      UnknownData_IXCZ[0x20];                                    // 0x00B8(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FText                                       CachedWidgetReadableLocation;                              // 0x00F0(0x0018) ELEMENT_SIZE_MISMATCH
	unsigned char                                      UnknownData_GTLQ[0x20];                                    // 0x00F0(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_I6FS[0x4];                                     // 0x014C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Y6T2[0x7];                                     // 0x0191(0x0007) MISSED OFFSET (PADDING)
