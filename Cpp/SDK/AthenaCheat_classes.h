...
public:
	...
	unsigned char                                      UnknownData_25VK[0x28];                                    // 0x0088(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XH9O[0x4C];                                    // 0x00D4(0x004C) MISSED OFFSET (PADDING)
