...
{
public:
	unsigned char                                      UnknownData_5S9H[0x20];                                    // 0x0068(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_NH7V[0x20];                                    // 0x0068(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_42Z6[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_GR4Y[0x30];                                    // 0x0078(0x0030) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_IP62[0x48];                                    // 0x0068(0x0048) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_T690[0x40];                                    // 0x0068(0x0040) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_J8AT[0x30];                                    // 0x0068(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_ZARQ[0x8];                                     // 0x0068(0x0008) MISSED OFFSET (PADDING)
