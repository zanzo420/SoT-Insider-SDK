...
struct FPerComanyItemQualityEntry
{
	...
	unsigned char                                      UnknownData_P8QK[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (PADDING)
...
struct FComplexItemQualityEntry
{
	...
	unsigned char                                      UnknownData_U9YS[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
