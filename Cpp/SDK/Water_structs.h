...
struct FWaterInformation
{
	...
	unsigned char                                      UnknownData_8FHD[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_F8OW[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0PB2[0x2];                                     // 0x004A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              StaticWaterHeightValue;                                    // 0x004C(0x0004) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_HDU1[0x88];                                    // 0x0050(0x0088) MISSED OFFSET (PADDING)
...
struct FSplashProbe
{
	unsigned char                                      UnknownData_N719[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VNES[0x1];                                     // 0x00F3(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Y2KB[0x7];                                     // 0x0101(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_S966[0x18];                                    // 0x0110(0x0018) MISSED OFFSET (PADDING)
...
struct FBuoyancyVolumeSample
{
	...
	unsigned char                                      UnknownData_1R2M[0x2];                                     // 0x0012(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BGFH[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_V447[0x10];                                    // 0x0048(0x0010) MISSED OFFSET (PADDING)
...
struct FBuoyancyDragSample
{
	...
	unsigned char                                      UnknownData_HDNL[0x63];                                    // 0x002D(0x0063) MISSED OFFSET (PADDING)
...
struct FWaterBuoyancy
{
	...
	unsigned char                                      UnknownData_33EB[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NH03[0xEC];                                    // 0x0044(0x00EC) MISSED OFFSET (PADDING)
...
struct FBuoyancySampleMovementConfigurationEntry
{
	...
	unsigned char                                      UnknownData_WFBF[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBuoyancySampleMovementConfiguration
{
	...
	unsigned char                                      UnknownData_KKA8[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BZ1A[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
struct FBuoyancySampleMovement
{
	...
	unsigned char                                      UnknownData_L9G8[0x40];                                    // 0x0010(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_D6ZT[0x8];                                     // 0x0060(0x0008) MISSED OFFSET (PADDING)
...
struct FWaterSpout
{
	...
	unsigned char                                      UnknownData_AEN3[0x30];                                    // 0x0040(0x0030) MISSED OFFSET (PADDING)
...
struct FWaterSplashProbesContainer
{
	...
	unsigned char                                      UnknownData_US7P[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_6HPK[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_P5D3[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FFFTWaterQueryResult
{
	...
	unsigned char                                      UnknownData_F254[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (PADDING)
