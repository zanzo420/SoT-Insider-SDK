...
public:
	...
	unsigned char                                      UnknownData_4FLZ[0xAC];                                    // 0x0594(0x00AC) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_X3QB[0x7];                                     // 0x0071(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_2CU1[0x8];                                     // 0x03D0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NKUW[0x88];                                    // 0x0498(0x0088) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_9OSX[0x8];                                     // 0x02E8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_52MW[0x8];                                     // 0x0618(0x0008) Fix Super Size
