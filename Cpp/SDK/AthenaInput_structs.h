...
struct FNotificationInputDisplayName
{
	...
	unsigned char                                      UnknownData_P3IL[0x20];                                    // 0x0008(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FIdleTimeTracker
{
	...
	unsigned char                                      UnknownData_5CFU[0x30];                                    // 0x0008(0x0030) MISSED OFFSET (PADDING)
...
struct FPrioritizedCompositeInputHandler
{
	...
	unsigned char                                      UnknownData_MNGS[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
struct FCompositeInputDelegator
{
	...
	unsigned char                                      UnknownData_VYIU[0x50];                                    // 0x0010(0x0050) MISSED OFFSET (PADDING)
